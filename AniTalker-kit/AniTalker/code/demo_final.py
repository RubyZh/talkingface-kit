...
def frames_to_video(input_path, audio_path, output_path, fps=float(25)):
    ...
    final_video.write_videofile(output_path, fps=float(25), codec='libx264', audio_codec='aac')
...
def main(args):
    ...
    if args.face_sr and check_package_installed('gfpgan'):
        ...
        final_clip.write_videofile(predicted_video_512_path, fps=float(25), codec='libx264', audio_codec='aac')
